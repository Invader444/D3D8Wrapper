...
// VertexBufferWrapper.h : Declaration of the CVertexBufferWrapper
#pragma once
...
class ATL_NO_VTABLE CVertexBufferWrapper :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CVertexBufferWrapper, &CLSID_VertexBufferWrapper>,
	public IVertexBufferWrapper,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_VERTEXBUFFERWRAPPER)

	DECLARE_NOT_AGGREGATABLE(CVertexBufferWrapper)

	using CComObjectRootEx<CComSingleThreadModel>::Lock;

	BEGIN_COM_MAP(CVertexBufferWrapper)
		COM_INTERFACE_ENTRY(IVertexBufferWrapper)
		COM_INTERFACE_ENTRY_IID(IID_IDirect3DVertexBuffer8, CVertexBufferWrapper)
	END_COM_MAP()
...
OBJECT_ENTRY_AUTO(__uuidof(VertexBufferWrapper), CVertexBufferWrapper)
