...
// CubeTextureWrapper.h : Declaration of the CCubeTextureWrapper
#pragma once
...
class ATL_NO_VTABLE CCubeTextureWrapper :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CCubeTextureWrapper, &CLSID_CubeTextureWrapper>,
	public ICubeTextureWrapper,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_CUBETEXTUREWRAPPER)

	DECLARE_NOT_AGGREGATABLE(CCubeTextureWrapper)

	BEGIN_COM_MAP(CCubeTextureWrapper)
		COM_INTERFACE_ENTRY(ICubeTextureWrapper)
		COM_INTERFACE_ENTRY_IID(IID_IDirect3DCubeTexture8, CCubeTextureWrapper)
	END_COM_MAP()
...
OBJECT_ENTRY_AUTO(__uuidof(CubeTextureWrapper), CCubeTextureWrapper)
