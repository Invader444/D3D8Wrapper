...
#ifndef _WIN32_WINNT            // Specifies that the minimum required platform is Windows 2K.
...
#define _WIN32_IE _WIN32_IE_IE501        // Change this to the appropriate value to target other versions of IE.
#endif
