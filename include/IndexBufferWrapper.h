...
// IndexBufferWrapper.h : Declaration of the CIndexBufferWrapper
#pragma once
...
class ATL_NO_VTABLE CIndexBufferWrapper :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CIndexBufferWrapper, &CLSID_IndexBufferWrapper>,
	public IIndexBufferWrapper,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_INDEXBUFFERWRAPPER)

	DECLARE_NOT_AGGREGATABLE(CIndexBufferWrapper)

	using CComObjectRootEx<CComSingleThreadModel>::Lock;

	BEGIN_COM_MAP(CIndexBufferWrapper)
		COM_INTERFACE_ENTRY(IIndexBufferWrapper)
		COM_INTERFACE_ENTRY_IID(IID_IDirect3DIndexBuffer8, CIndexBufferWrapper)
	END_COM_MAP()
...
OBJECT_ENTRY_AUTO(__uuidof(IndexBufferWrapper), CIndexBufferWrapper)
